...
final class AppLocalizerTests: XCTestCase {
    ...
    func testReadsLocalizedStringsFromResourceCatalog() {
        ...
        XCTAssertEqual(AppLocalizer.text(.aboutVersionValue, locale: .english), "1.3.6")
        XCTAssertEqual(AppLocalizer.text(.aboutVersionValue, locale: .traditionalChinese), "1.3.6")
        XCTAssertEqual(AppLocalizer.text(.aboutVersionValue, locale: .simplifiedChinese), "1.3.6")
