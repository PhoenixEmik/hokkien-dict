...
final class AppLocalizerTests: XCTestCase {
    ...
    func testReadsLocalizedStringsFromResourceCatalog() {
        ...
        XCTAssertEqual(AppLocalizer.text(.aboutVersionValue, locale: .english), "1.4.0")
        XCTAssertEqual(AppLocalizer.text(.aboutVersionValue, locale: .traditionalChinese), "1.4.0")
        XCTAssertEqual(AppLocalizer.text(.aboutVersionValue, locale: .simplifiedChinese), "1.4.0")
        XCTAssertEqual(AppLocalizer.text(.aboutVersionValue, locale: .japanese), "1.4.0")
        XCTAssertEqual(AppLocalizer.text(.aboutGitHub, locale: .traditionalChinese), "開放源碼")
        XCTAssertEqual(AppLocalizer.text(.aboutPrivacy, locale: .traditionalChinese), "隱私權政策")
