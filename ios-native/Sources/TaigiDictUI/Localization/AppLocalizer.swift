...
public enum AppLocalizedStringKey: String, CaseIterable {
    ...
    case settingsRedownloadWordAudio
    case settingsRedownloadSentenceAudio
    case settingsActionsMenu
    case settingsClearConfirmTitle
    case settingsClearConfirmBody
    case settingsRebuildConfirmTitle
    case settingsRebuildConfirmBody
    case commonBack
    case commonDelete
    case commonCancel
    case commonForward
    ...
    case audioStatusNeedsDictionaryUpdate
    ...
    case licenseMetadataSection
    case licenseTextSection
    case licenseAgreement
    case licenseRepository
    case licenseVersion
    case licenseIncludedVia
    case licenseMarisaNotice
